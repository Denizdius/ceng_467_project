...
# Qwen3-8B Base 4-bit QLoRA on DEITA-6k (save LoRA adapters).
...
#
# Usage:
#   bash scripts/run_train_deita_seq1024_qwen3_8b_qlora.sh
#
# Optional overrides:
#   OUTPUT_DIR=outputs/baseline3_deita_seq1024
#   EPOCHS=1
#   MAX_SEQ_LEN=1024
#   BS=2
#   GAS=4
...
OUTPUT_DIR="${OUTPUT_DIR:-outputs/baseline3_deita_seq1024}"
EPOCHS="${EPOCHS:-1}"
...
RUN_LABEL="${RUN_LABEL:-Qwen3-8B QLoRA DEITA seq1024}"
